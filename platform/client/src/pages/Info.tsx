  ...
  const renderContent = () => {
    switch (page) {
      ...
      case "data-processing":
        return (
          <div>
            <h1 className="text-4xl font-bold text-slate-900 mb-6">Обработка персональных данных</h1>
            <div className="prose prose-lg max-w-none text-slate-600 space-y-4">
              <p>
                Настоящий раздел составлен в соответствии с Федеральным законом РФ от 27.07.2006 N 152-ФЗ
                &quot;О персональных данных&quot; и определяет порядок обработки персональных данных пользователей
                платформы TaskHive.
              </p>
              <h2 className="text-2xl font-bold text-slate-900 mt-8">1. Оператор персональных данных</h2>
              <p>
                Оператором персональных данных является TaskHive. По вопросам обработки данных: support@taskhive.com.
              </p>
              <h2 className="text-2xl font-bold text-slate-900 mt-8">2. Цели обработки</h2>
              <ul className="list-disc list-inside space-y-2">
                <li>Регистрация и обслуживание учетной записи пользователя</li>
                <li>Исполнение договорных обязательств и оказание услуг платформы</li>
                <li>Обработка платежей, возвратов и разрешение споров</li>
                <li>Информационные уведомления о работе сервиса</li>
                <li>Соблюдение требований законодательства РФ</li>
              </ul>
              <h2 className="text-2xl font-bold text-slate-900 mt-8">3. Правовые основания</h2>
              <ul className="list-disc list-inside space-y-2">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8">4. Права пользователя</h2>
              <ul className="list-disc list-inside space-y-2">
              ...
              <h2 className="text-2xl font-bold text-slate-900 mt-8">5. Сроки и условия хранения</h2>
              <p>
                Персональные данные хранятся не дольше, чем этого требуют цели обработки или нормы законодательства РФ.
                По достижении целей обработки данные удаляются или обезличиваются.
              </p>
              <h2 className="text-2xl font-bold text-slate-900 mt-8">6. Трансграничная передача</h2>
              <p>
                Трансграничная передача персональных данных осуществляется только при наличии правовых оснований и при
